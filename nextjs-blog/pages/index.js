...
import { getSortedPostsData } from '../lib/posts-firebase'; // Imports function from posts-firebase.js
...
export async function getStaticProps() {
  // Using await due to the nature of using async in posts-firebase.js
